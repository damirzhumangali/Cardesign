...
export function createSceneApp(canvas) {
  ...
  const sizes = getViewportSize(canvas);
...
export function updateRendererSize(app) {
  const nextSize = getViewportSize(app.canvas);

  app.sizes.width = nextSize.width;
  app.sizes.height = nextSize.height;

  app.camera.aspect = app.sizes.width / app.sizes.height;
  app.camera.updateProjectionMatrix();

  app.renderer.setSize(app.sizes.width, app.sizes.height, false);
